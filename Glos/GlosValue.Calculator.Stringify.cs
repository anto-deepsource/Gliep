        ...
        public partial class Calculator {
            ...
            public static string DebugStringify(in GlosValue v) {
                return v.Type switch {
                    ...
                    GlosValueType.ExternalPureFunction  => $"<external pure function: {RuntimeHelpers.GetHashCode(v.AssumeExternalPureFunction()):x8}>",
                    GlosValueType.ExternalAsyncFunction => $"<external async function: {RuntimeHelpers.GetHashCode(v.AssumeExternalAsyncFunction()):x8}>",
